...
/// Testing Method 2 : mocking useCurrentPosition///
...
test("should display error when it fails to load location", async () => {
  const fakeError = new Error("error fethcing geolocation");
